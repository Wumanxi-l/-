...
public partial class Admin_WuLiu : System.Web.UI.Page
{
    ...
    protected void Bind()
    {
        ...
        if (Request.QueryString["SearchText"] != null)
        {
            ...
            GridView1.DataSource = wuliuSrv.GetProductBySearchText(strSearchText);
            GridView1.DataBind();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/WuLiu.aspx" + strQuery);
    }
}