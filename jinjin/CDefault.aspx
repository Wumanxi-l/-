<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageCouerier.master" AutoEventWireup="true" CodeFile="CDefault.aspx.cs" Inherits="CDefault" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
   ...
   <div class="cok">
        ...
        <asp:Button runat="server" Text="确定"  Width="117px" OnClick="Unnamed1_Click1" Height="50px" />
    </div>
        <div class="cokl">
